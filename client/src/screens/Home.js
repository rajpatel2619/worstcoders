...
class Home extends React.Component {
  ...
  changeContest = async (current_contest) => {
    ...
    this.state.data = [];
    this.setState({});
    await axios.get(`/${current_contest}`).then((res) => {
      if (!res.data.message) {
...
If you found this product helpful, consider supporting me with a cup of coffee!
      ...
      <img src="https://cdn.buymeacoffee.com/buttons/v2/default-violet.png" alt="Buy Me A Coffee" />
        ...
        <div className="credit">Designed with ❤️ by:  <a style={{"textDecoration":"none","color":"#1d6ad6"}} href="https://instagram.com/raj_patel_2619" target="_blank">Raj Patel</a></div>
      </div>
    );
  }
}
